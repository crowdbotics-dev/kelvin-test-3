"""
Django settings for kelvin_test_3 project.
...
ROOT_URLCONF = 'kelvin_test_3.urls'
...
WSGI_APPLICATION = 'kelvin_test_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "kelvin_test_3 API",
    "DESCRIPTION": "API documentation for kelvin_test_3 App",
    "VERSION": "v1",
}
